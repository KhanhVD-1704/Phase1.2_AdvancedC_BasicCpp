...
| **TestZeroCapacity** | Khởi tạo FIFO với dung lượng 0 | Ném `std::invalid_argument` |
...
| **TestDebugPrint** | Hiển thị trạng thái FIFO | Không lỗi khi hiển thị trạng thái |
...
```bash
git clone https://github.com/KhanhVD-1704/Phase1.2_AdvancedC_BasicCpp.git
```
